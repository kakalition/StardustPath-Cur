import { Button, Input, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, SelectItem, Select, Textarea } from "@nextui-org/react"

function CategoriesFormModal({ isOpen, onOpenChange, onSubmit, register, errors }) {
  return (
    <Modal
      isOpen={isOpen}
      ...
      <ModalContent>
        {onClose => (
          <form onSubmit={onSubmit(onClose)}>
            <ModalHeader className="flex flex-col gap-1">Form Kategori</ModalHeader>
            <ModalBody>
              <input
                type="hidden"
                {...register("id")}
