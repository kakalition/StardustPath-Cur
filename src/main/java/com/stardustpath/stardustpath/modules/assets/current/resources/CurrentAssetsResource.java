package com.stardustpath.stardustpath.modules.assets.current.resources;
...
import com.stardustpath.stardustpath.modules.assets.current.services.CurrentAssetsService;
...
@Path("/api/assets/current")
@Produces(MediaType.APPLICATION_JSON)
@Consumes(MediaType.APPLICATION_JSON)
public class CurrentAssetsResource extends CommonResource {
    final CurrentAssetsService service;

    public CurrentAssetsResource(CurrentAssetsService service) {
        this.service = service;
    }

    @GET
    public Uni<GetCurrentAssetResult> get(
